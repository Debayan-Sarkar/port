    ...
    <div className="fixed bottom-6 left-6 z-50">
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="absolute left-12 top-1/2 -translate-y-1/2 bg-white text-black px-3 py-1 rounded-lg text-sm font-medium shadow-lg whitespace-nowrap"
            style={{ filter: "drop-shadow(0 0 10px rgba(0,0,0,0.1))" }}
          >
            Chat with us on WhatsApp
            <div className="absolute top-1/2 -left-2 -translate-y-1/2 w-0 h-0 border-t-[6px] border-b-[6px] border-r-[6px] border-transparent border-r-white"></div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.a
        ...
        animate={{
          opacity: 1,
          y: 0,
          boxShadow: isHovered ? "0 0 15px rgba(37, 211, 102, 0.6)" : "0 4px 8px rgba(0, 0, 0, 0.3)",
        }}
        transition={{
          type: "spring",
          stiffness: 400,
