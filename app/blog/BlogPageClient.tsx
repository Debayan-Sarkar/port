...
import { BlogPostSkeleton } from "@/components/skeleton-loaders"
        ...
        <div className="min-h-screen bg-[#0e0e0e] text-white">
          ...
          <main className="pt-24">
            <section className="pt-32 pb-16 relative overflow-hidden">
              <div className="container px-4 md:px-6">
                <div className="max-w-4xl mx-auto text-center">
                  <BlogPostSkeleton className="h-4 w-32 mx-auto mb-4" />
                  <BlogPostSkeleton className="h-12 w-3/4 mx-auto mb-6" />
                  <div className="flex flex-wrap items-center justify-center gap-4 mb-8">
                    <BlogPostSkeleton className="h-4 w-24" />
                    <BlogPostSkeleton className="h-4 w-24" />
                    <BlogPostSkeleton className="h-4 w-32" />
                  </div>
                </div>
              </div>
            </section>
            ...
            <div className="container px-4 md:px-6 mb-16">
              <BlogPostSkeleton className="max-w-5xl mx-auto h-[300px] md:h-[500px] rounded-xl" />
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                  <div className="lg:w-2/3">
                    <div className="space-y-6">
                      {[1, 2, 3, 4, 5, 6].map((i) => (
                        <BlogPostSkeleton key={i} className="h-6 w-full" />
                      ))}
                    </div>

                    <div className="mt-12">
                      <BlogPostSkeleton className="h-6 w-32 mb-4" />
                      <div className="flex flex-wrap gap-2">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <BlogPostSkeleton className="h-8 w-20 rounded-full" />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="mt-12 border-t border-white/10 pt-8">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-2">
                          <BlogPostSkeleton className="h-8 w-8 rounded-full" />
                          <BlogPostSkeleton className="h-8 w-8 rounded-full" />
                          <BlogPostSkeleton className="h-8 w-8 rounded-full" />
                        </div>
                      </div>
                    ...
                    <div className="mt-12 bg-[#151515] p-8 rounded-xl">
                      <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                        <BlogPostSkeleton className="w-24 h-24 rounded-full" />
                        <div>
                          <BlogPostSkeleton className="h-6 w-48 mb-2" />
                          <BlogPostSkeleton className="h-4 w-32 mb-4" />
                          <BlogPostSkeleton className="h-4 w-full" />
                          <BlogPostSkeleton className="h-4 w-full" />
                          <BlogPostSkeleton className="h-4 w-3/4" />
                        </div>
                      </div>
                    </div>

                    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                      <BlogPostSkeleton className="h-32 rounded-lg" />
                      <BlogPostSkeleton className="h-32 rounded-lg" />
                    </div>
                  </div>
                  ...
                  <div className="lg:w-1/3">
                    <div className="bg-[#151515] p-8 rounded-xl mb-8">
                      <BlogPostSkeleton className="h-6 w-48 mb-6" />
                      <div className="space-y-6">
                        {[1, 2, 3].map((i) => (
                          <div key={i} className="flex gap-4">
                            <BlogPostSkeleton className="w-20 h-20 rounded-lg" />
                            <div>
                              <BlogPostSkeleton className="h-5 w-32 mb-2" />
                              <BlogPostSkeleton className="h-4 w-24" />
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="space-y-2">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <div key={i} className="flex items-center justify-between py-2 border-b border-white/5">
                            <BlogPostSkeleton className="h-4 w-32" />
                            <BlogPostSkeleton className="h-6 w-8 rounded-full" />
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="bg-[#151515] p-8 rounded-xl">
                      <BlogPostSkeleton className="h-6 w-48 mb-4" />
                      <BlogPostSkeleton className="h-16 w-full mb-6" />
                      <BlogPostSkeleton className="h-12 w-full mb-4" />
                      <BlogPostSkeleton className="h-12 w-full" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="min-h-screen bg-[#0e0e0e] text-white overflow-hidden">
        ...
        <main className="pt-24">
          ...
          <section className="pt-32 pb-16 relative overflow-hidden">
            ...
            <div className="container px-4 md:px-px-6">
              <div className="max-w-4xl mx-auto text-center">
                <motion.div
